...
class Libreta extends PositionComponent {
  ...
  void render(Canvas canvas) {
    ...
    var cuerpo_libreta= Path()
      ..moveTo(size.x*.400, .250*size.x)
      ..lineTo(size.x*.400, .550*size.x)
      ..lineTo(size.x*.600, .550*size.x)
      ..lineTo(size.x*.600, .250*size.x)
      ..close();
    ...
    final Marca=
        Rect.fromCenter(center: Offset(size.x*.570,size.x*.270), width: .040*size.x, height: .020*size.x);

    final Detalle_marca=
        Rect.fromCenter(center: Offset(size.x*.570,size.x*.295), width: .055*size.x, height: .040*size.x);
    final Detalle_libreta=
        Rect.fromCenter(center: Offset(size.x*.583,size.x*.505), width: .015*size.x, height: .060*size.x);
    
    //AGUJEROS ARGOLLAS
    final Argolla_libreta_agujero1=
        Rect.fromCenter(center: Offset(size.x*.390,size.x*.270), width: size.x*.010, height: size.x*.010);
     final Argolla_libreta_agujero2=
        Rect.fromCenter(center: Offset(size.x*.390,size.x*.300), width: size.x*.010, height: size.x*.010);
      final Argolla_libreta_agujero3=
        Rect.fromCenter(center: Offset(size.x*.390,size.x*.330), width: size.x*.010, height: size.x*.010);
      final Argolla_libreta_agujero4=
        Rect.fromCenter(center: Offset(size.x*.390,size.x*.360), width: size.x*.010, height: size.x*.010);
      final Argolla_libreta_agujero5=
        Rect.fromCenter(center: Offset(size.x*.390,size.x*.390), width: size.x*.010, height: size.x*.010);
      final Argolla_libreta_agujero6=
        Rect.fromCenter(center: Offset(size.x*.390,size.x*.420), width: size.x*.010, height: size.x*.010);
      final Argolla_libreta_agujero7=
        Rect.fromCenter(center: Offset(size.x*.390,size.x*.450), width: size.x*.010, height: size.x*.010);
      final Argolla_libreta_agujero8=
        Rect.fromCenter(center: Offset(size.x*.390,size.x*.480), width: size.x*.010, height: size.x*.010);
      final Argolla_libreta_agujero9=
        Rect.fromCenter(center: Offset(size.x*.390,size.x*.510), width: size.x*.010, height: size.x*.010);
        final Argolla_libreta_agujero10=
        Rect.fromCenter(center: Offset(size.x*.390,size.x*.540), width: size.x*.010, height: size.x*.010);
        
        //ARGOLLAS
         final Argolla_libreta9=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.535), width: size.x*.080, height: size.x*.020);
      final Argolla_libreta_Fondo9=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.535), width: size.x*.070, height: size.x*.020);
        final Argolla_libreta8=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.505), width: size.x*.080, height: size.x*.020);
      final Argolla_libreta_Fondo8=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.505), width: size.x*.070, height: size.x*.020);
        final Argolla_libreta7=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.475), width: size.x*.080, height: size.x*.020);
      final Argolla_libreta_Fondo7=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.475), width: size.x*.070, height: size.x*.020);
        final Argolla_libreta6=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.445), width: size.x*.080, height: size.x*.020);
      final Argolla_libreta_Fondo6=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.445), width: size.x*.070, height: size.x*.020);
      final Argolla_libreta5=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.415), width: size.x*.080, height: size.x*.020);
      final Argolla_libreta_Fondo5=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.415), width: size.x*.070, height: size.x*.020);
         final Argolla_libreta4=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.385), width: size.x*.080, height: size.x*.020);
      final Argolla_libreta_Fondo4=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.385), width: size.x*.070, height: size.x*.020);
         final Argolla_libreta3=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.355), width: size.x*.080, height: size.x*.020);
      final Argolla_libreta_Fondo3=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.355), width: size.x*.070, height: size.x*.020);
           final Argolla_libreta2=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.325), width: size.x*.080, height: size.x*.020);
      final Argolla_libreta_Fondo2=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.325), width: size.x*.070, height: size.x*.020);
         final Argolla_libreta1=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.295), width: size.x*.080, height: size.x*.020);
      final Argolla_libreta_Fondo1=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.295), width: size.x*.070, height: size.x*.020);
          final Argolla_libreta0=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.265), width: size.x*.080, height: size.x*.020);
      final Argolla_libreta_Fondo0=
        Rect.fromCenter(center: Offset(size.x*.405,size.x*.265), width: size.x*.070, height: size.x*.020);
