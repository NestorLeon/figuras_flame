...
class Sello extends PositionComponent {
  ...
  void render(Canvas canvas) {
    ...
    // Circulos
    final posiscioncirc =
        Offset(((0.1 / 0.256) * size.x), ((0.2 / 0.8) * size.y));
    canvas.drawCircle(
      posiscioncirc,
      1 / 75 * size.x,
...
//       // Circulos
    final posiscioncirc1 =
        Offset(((0.1 / 0.256) * size.x), ((0.6 / 0.8) * size.y));
    canvas.drawCircle(
      posiscioncirc1,
      1 / 75 * size.x,
      Paint()..color = Color.fromARGB(255, 97, 81, 58),
...
//      // Circulos
    final posiscioncirc2 =
        Offset(((0.1 / 0.189) * size.x), ((0.2 / 0.8) * size.y));
    canvas.drawCircle(
      posiscioncirc2,
      1 / 75 * size.x,
      Paint()..color = Color.fromARGB(255, 97, 81, 58),
...
//       // Circulos
    final posiscioncirc3 =
        Offset(((0.1 / 0.189) * size.x), ((0.6 / 0.8) * size.y));
    canvas.drawCircle(
      posiscioncirc3,
      1 / 75 * size.x,
      Paint()..color = Color.fromARGB(255, 97, 81, 58),
    );
    final posiscioncirc3m =
        Offset(((0.1 / 0.189) * size.x), ((0.6 / 0.8) * size.y));
    canvas.drawCircle(
      posiscioncirc3m,
      1 / 90 * size.x,
...
//    // Circulos
    final posiscioncirc29 =
        Offset(((0.1 / 0.377) * size.x), ((0.2 / 0.8) * size.y));
    canvas.drawCircle(
      posiscioncirc29,
      1 / 75 * size.x,
      Paint()..color = Color.fromARGB(255, 97, 81, 58),
...
// // Circulos
    ...
    final posicioninicio =
        Offset(((0.023 / 0.6) * size.x), ((0.4 / 0.8) * size.y));
    canvas.drawCircle(posicioninicio, 1 / 33 * size.x,
        Paint()..color = Color.fromARGB(255, 123, 103, 73));
    final posicionmedio =
        Offset(((0.023 / 0.6) * size.x), ((0.4 / 0.8) * size.y));
    canvas.drawCircle(posicionmedio, 1 / 56 * size.x,
        Paint()..color = Color.fromARGB(255, 83, 68, 45));

    final posicionfinal =
        Offset(((0.519 / 0.6) * size.x), ((0.4 / 0.8) * size.y));
    canvas.drawCircle(posicionfinal, 1 / 28 * size.x,
        Paint()..color = Color.fromARGB(255, 123, 103, 73));
    final posicionfinal1 =
        Offset(((0.519 / 0.6) * size.x), ((0.4 / 0.8) * size.y));
    canvas.drawCircle(posicionfinal1, 1 / 45 * size.x,
        Paint()..color = Color.fromARGB(255, 83, 68, 45));

//romboinicio1
    final centerXi1 = size.x * 0.1; // Cambio de división a multiplicación
    final centerYi1 = size.y * 0.1; // Cambio de división a multiplicación
    final romboSizei1X = size.x * 0.05;
