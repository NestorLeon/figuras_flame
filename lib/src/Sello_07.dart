...
class Sello_07 extends PositionComponent {
  ...
  // );
    ...
    //Dedos
      ...
      ..moveTo(((1 / 6) * size.x), ((.85/ 8) * size.y))
      ..lineTo(((1 / 6.5) * size.x), ((1.1/ 8) * size.y))
  ...
  final cuerpo= Path()
      ...
      ..quadraticBezierTo(((5.3 / 7) * size.x), ((1.8/ 8) * size.y),((1.7 / 7) * size.x), ((1.9/ 8) * size.y))
      ..close;
