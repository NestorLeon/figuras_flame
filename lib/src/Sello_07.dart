  ...
  // );
    ...
    //Dedos
      ...
      ..lineTo(((1 / 6) * size.x), ((.85/ 8) * size.y))
       ..moveTo(((1 / 8) * size.x), ((.95/ 8) * size.y))
      ..lineTo(((1 / 7) * size.x), ((.95/ 8) * size.y))
      ..moveTo(((1 / 9) * size.x), ((1.05/ 8) * size.y))
      ..lineTo(((1 / 7) * size.x), ((1.05/ 8) * size.y))
      ..moveTo(((.9 / 9) * size.x), ((1.15/ 8) * size.y))
      ..lineTo(((1 / 7) * size.x), ((1.15/ 8) * size.y))
      ..moveTo(((1 / 9.3) * size.x), ((1.25/ 8) * size.y))
      ..lineTo(((1 / 7) * size.x), ((1.25/ 8) * size.y))

      ..moveTo(((1 / 7) * size.x), ((1.25/ 8) * size.y))
      ..lineTo(((1 / 7) * size.x), ((1.15/ 8) * size.y))
