...
class Sello_050 extends PositionComponent {
  ...
  void render(Canvas canvas) {
    ...
    final circulo1 =
        Offset(((0.01 / 0.180) * size.x), ((0.13 / 0.80) * size.y));
    canvas.drawCircle(
        circulo1,
        0.15 * 0.20 * size.x, //diametro 2.5/90
        paint
          ..style = PaintingStyle.stroke
          ..strokeWidth = size.y * 0.02 //no rellenar
        );

    final circulo2 =
        Offset(((0.0276 / 0.08) * size.x), ((0.30 / 0.8) * size.y));
    canvas.drawCircle(
        circulo2,
        0.15 * 0.20 * size.x, //diametro
        paint..style = PaintingStyle.stroke //no rellenar
        );
    ...
    canvas.drawRect(Rect1, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect2, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect3, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect4, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect5, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect6, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect7, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect8, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect9, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect10, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect11, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect12, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect13, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect14, paint..style = PaintingStyle.fill);
//---------------
    ...
    canvas.drawRect(Rect15, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect16, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect17, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect18, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect19, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect20, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect21, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect22, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect23, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect24, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect25, paint..style = PaintingStyle.fill);
    ...
    canvas.drawRect(Rect26, paint..style = PaintingStyle.fill);
