...
class Sello_002 extends PositionComponent {
  ...
  void render(Canvas canvas) {
    ...
    //forma4
    canvas.rotate(-0.523);
    canvas.drawArc(Rect.fromLTWH(-45, 19, size.x / 3.2, size.y), radio,
        radio / 2, false, paint..strokeWidth = 4);

    canvas.rotate(0.523);

    //cuadro
    canvas.drawRect(
        Rect.fromLTWH(size.x / 2.6, size.y * 0.5, size.x * 0.5, size.y * 0.39),
    ...
    final circleRadius =
        16.0; // Puedes ajustar este valor según el tamaño deseado del círculo
